...
uint32_t CRC8_VerifyCheckSum(uint8_t *pchMessage, uint32_t dwLength)
{
  ...
  if ((pchMessage == 0) || (dwLength <= 2))
    return 0;
  ucExpected = CRC8_GetCheckSum(pchMessage, dwLength - 1, CRC8_INIT);
...
void CRC8_AppendCheckSum(uint8_t *pchMessage, uint32_t dwLength)
{
  ...
  if ((pchMessage == 0) || (dwLength <= 2))
    return;
  ucCRC = CRC8_GetCheckSum((uint8_t *)pchMessage, dwLength - 1, CRC8_INIT);
...
uint32_t CRC16_VerifyCheckSum(uint8_t *pchMessage, uint32_t dwLength)
{
  ...
  wExpected = CRC16_GetCheckSum(pchMessage, dwLength - 2, CRC16_INIT);
...
void CRC16_AppendCheckSum(uint8_t *pchMessage, uint32_t dwLength)
{
  ...
  wCRC = CRC16_GetCheckSum((uint8_t *)pchMessage, dwLength - 2, CRC16_INIT);
